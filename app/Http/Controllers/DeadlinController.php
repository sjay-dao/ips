...
class DeadlinController extends Controller
{
    ...
    public function getlistofDeadline(){// this is for getting the notifications
        $a = (Object)array();
        // // for patent
        ...
        for($x=0; $x<$patent_year; $x++){
            ...
            $results[$x] = Ip::select('type_id','date_filed','name', 'date_approved')->
        ...
        for($x=0; $x<7; $x++){
            ...
            $results1[$x] = Ip::select('type_id','date_filed','name', 'date_approved')->
        ...
        for($x=0; $x<3; $x++){
            ...
            $results4[$x] = Ip::select('type_id','date_filed','name', 'date_approved')->
        ...
        for($x=0; $x<$year_5th; $x++){
            ...
            $results3[$x] = Ip::select('type_id','date_filed','name', 'date_approved')->
         ...
         for($x=0; $x<$tm_renewal_year; $x++){
             ...
             $results2[$x] = Ip::select('type_id','date_filed','name', 'date_approved')->
        ...
        return json_encode($a->sortBy('date_filed'));

        // // for Trademark's renewal 
        // $strdatefrom2 = strtotime(((int)date('Y')-10) . "/" .date('m') . "/". date('d'));
        // $strdateto2 = strtotime(((int)date('Y')-9) . "/" .date('m') . "/". date('d'));
        // $datefrom2 = date('Y-m-d',$strdatefrom2);
        // $dateto2 = date('Y-m-d',$strdateto2);

        // $strdatefrom3 = strtotime(((int)date('Y')-5) . "/" .date('m') . "/". date('d'));
        // $strdateto3 = strtotime(((int)date('Y')-4) . "/" .date('m') . "/". date('d'));
        // $datefrom3 = date('Y-m-d',$strdatefrom3);
        // $dateto3 = date('Y-m-d',$strdateto3);
        ...
        // $collection = (Object)array('type' => '1', 'name'=>'Name1');
        // $other_collection = (Object)array('type' => '2', 'name'=>'Name2');

        // $new_collection = (object)array_merge_recursive((array)$collection , (array)$other_collection);
        // $new_collection = $collection->merge($other_collection);

        // return json_encode($new_collection);
        // return "hello";
    }
}
